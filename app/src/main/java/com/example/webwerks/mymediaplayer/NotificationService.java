...
public class NotificationService extends Service implements ExoPlayer.EventListener{
    Notification status;
    ...
    private void startMediaPlayer() {
        ...
        Toast.makeText(NotificationService.this, "Exoplayer is playing.", Toast.LENGTH_SHORT).show();
    }
